...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitlum/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/bitlum/btcd/blockchain/fullblocktests
```
