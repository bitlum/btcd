...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitlum/btcd/peer)
...
```bash
$ go get -u github.com/bitlum/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/bitlum/btcd/peer#example-package--NewOutboundPeer)  
